...
const nutritionProfiles = [
  {
    name: "Vollwertig & Ausgewogen",
    description: "Natürliche, unverarbeitete Lebensmittel aus allen Gruppen. Getreide, Hülsenfrüchte, Gemüse, Obst und tierische Produkte in Maßen.",
    excludedIngredients: [],
    preferredCategories: ["Gemüse", "Getreide", "Hülsenfrüchte"],
    mealStyle: "varied",
    energyLabel: "ausgewogen",
  },
  {
    name: "Pflanzenbasiert",
    description: "Überwiegend pflanzliche Ernährung. Viel Gemüse, Obst, Hülsenfrüchte, Nüsse und Saaten. Tierische Produkte werden reduziert oder gemieden.",
    excludedIngredients: ["Fleisch", "Wurst"],
    preferredCategories: ["Gemüse", "Hülsenfrüchte", "Nüsse"],
    mealStyle: "plant-based",
    energyLabel: "leicht",
  },
  {
    name: "Mediterran",
    description: "Olivenöl, Fisch, Hülsenfrüchte, frisches Gemüse und Kräuter. Wenig rotes Fleisch, viel Genuss am Tisch.",
    excludedIngredients: [],
    preferredCategories: ["Gemüse", "Fisch", "Olivenöl", "Kräuter"],
    mealStyle: "mediterranean",
    energyLabel: "leicht",
  },
  {
    name: "Kraftvoll & Sättigend",
    description: "Proteinreich und nährstoffdicht. Für Menschen mit aktivem Lebensstil. Viel Hülsenfrüchte, Eier, mageres Fleisch und komplexe Kohlenhydrate.",
    excludedIngredients: [],
    preferredCategories: ["Fleisch", "Hülsenfrüchte", "Eier"],
    mealStyle: "high-protein",
    energyLabel: "sättigend",
  },
  {
    name: "Leicht & Bekömmlich",
    description: "Schonend zubereitet, leicht verdaulich. Ideal bei empfindlichem Magen oder nach dem Essen wach bleiben wollen. Wenig Fett, viel Dampfgegartes.",
    excludedIngredients: ["Rohkost"],
    preferredCategories: ["Gemüse", "Fisch", "Reis"],
    mealStyle: "gentle",
    energyLabel: "leicht",
  },
];
